    ...
    <div className="min-h-screen bg-gradient-to-r from-blue-500 to-teal-400 flex flex-col items-center font-sans">
      ...
      <section className="text-center mt-12 px-4">
        ...
        <div className="mt-8 flex justify-center space-x-6">
          <button className="bg-white text-blue-600 font-semibold px-8 py-3 rounded-lg shadow-md hover:bg-gray-100 transition" onClick={handleSignup}>
            Sign Up
          </button>
      ...
      <section className="mt-24 w-full max-w-7xl px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Feature 1 */}
          <div className="feature-card" onClick={handleSkillmatching}>
